...
public class AwardService {
    ...
    public PaginationData<Award> getAwardPagination(AwardsPaginationRequest awardsPaginationRequest) {
        Pageable pageable = PageRequest.of(awardsPaginationRequest.getPage(), awardsPaginationRequest.getSize());
        PaginationData<Award> awardPagination = PaginationData.of(awardRepository.findAllBy(awardsPaginationRequest.getName(), awardsPaginationRequest.getAwardDate(), pageable));
