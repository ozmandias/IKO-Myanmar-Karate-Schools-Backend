...
import com.james.IKO_Myanmar.model.Dojo;
import com.james.IKO_Myanmar.repository.DojoRepository;
...
public class DojoService {
    ...
    public Dojo createDojo(Dojo dojoData) {
        dojoData.create_date = LocalDateTime.now();
    ...
    public Dojo updateDojo(Long id, Dojo dojoData) {
        ...
        if(optionalDojo.isPresent()) {
            ...
            dojoData.id = dojo.id;
            dojoData.create_date = dojo.create_date;
            dojoData.update_date = LocalDateTime.now();
