...
import com.james.IKO_Myanmar.repository.StudentRepository;
...
public class StudentService {
    ...
    public Student createStudent(Student studentData) {
        studentData.create_date = LocalDateTime.now();
    ...
    public Student updateStudent(Long id, Student studentData) {
        ...
        if(optionalStudent.isPresent()) {
            ...
            studentData.create_date = student.create_date;
            studentData.update_date = LocalDateTime.now();
