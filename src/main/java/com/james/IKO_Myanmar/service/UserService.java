...
import com.james.IKO_Myanmar.repository.UserSQLRepository;
import com.james.IKO_Myanmar.model.User;
import com.james.IKO_Myanmar.repository.UserRepository;
...
public class UserService {
    ...
    public User createUser(User userData) {
        ...
        userData.create_date = LocalDateTime.now();
    ...
    public User updateUser(Long id, User userData) {
        ...
        if(optionalUser.isPresent()) {
            ...
            userData.id = user.id;
            userData.create_date = user.create_date;
            userData.update_date = LocalDateTime.now();
